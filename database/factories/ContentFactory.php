...
class ContentFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'genre'  => json_encode(['genre1' => $this->faker->word, 'genre2' => $this->faker->word]),
            'tags'  => json_encode(['tag1' => $this->faker->word, 'tag2' => $this->faker->word]),
            'runtime' => $this->faker->numberBetween(1,200),
            'short_description' =>  $this->faker->text,
            'cast'  => json_encode(['starring1' => $this->faker->name, 'starring2' => $this->faker->name]),
            'directors' => json_encode(['director1' => $this->faker->name, 'director2' => $this->faker->name]),
